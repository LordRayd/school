...
public class Instruction { // TODO : A COMPLETER (méthode executer() seulement)
    ...
    public short executer() { // TODO : A COMPLETER
        ...
        case LDL: // TODO : a completer
        	short varLocal = Memoire.lireVariableLocale(argument);
        ...
        case LDG: // TODO : a completer
        	short varGlobal = Memoire.lireVariableGlobale(argument);
        	Memoire.empiler(varGlobal);
        	break;
        case STG: // TODO : a completer
        	short stg = Memoire.depiler();
        	Memoire.ecrireVariableGlobale(argument,stg);
        	break;
        case LDI:{ // TODO : a completer
        	short adr = Memoire.depiler();
        	short varAdresse = Memoire.lireEmplacement(adr);
        	Memoire.empiler(varAdresse);
        	break;
        }
        case STI:{ // TODO : a completer
        	short arg = Memoire.depiler();
        	short sti = Memoire.depiler();
        	Memoire.ecrireEmplacement(arg,sti);
        	break;
        }
        ...
        case JNZ: { // TODO : a completer
        	if(Memoire.depiler() != 0 ) adresse_instruction_suivante = argument;
            break;
        }
        ...
        case SND: { // TODO : a completer
        	short snd = Memoire.depiler();
        	EntreesSorties.ecrireEntier(snd);
            break;
        }
        case RCV: { // TODO : a completer
        	short rcv = EntreesSorties.lireEntier();
        	Memoire.empiler(rcv);
            break;
        }
