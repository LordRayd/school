...
public class RightPaneListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == this.frame.getRightPane().getRemoveColumn()){
			...
			String tableName = (String)JOptionPane.showInputDialog(this.frame, "Nom de la Table o&ugrave; supprimer la colonne :", "Choix de la table",JOptionPane.PLAIN_MESSAGE,null,listOfTable,listOfTable[0]);	

			if(tableName != null){

				String[] listOfColumns = this.frame.getDb().getInitJdbc().getTable().getColumnName(tableName);

				String columnName = (String)JOptionPane.showInputDialog(this.frame, "Nom de la colonne &agrave; supprimer :", "Choix de la colonne",JOptionPane.PLAIN_MESSAGE,null,listOfColumns,listOfColumns[0]);	
		...
		if(e.getSource() == this.frame.getRightPane().getRemoveLine()){
			...
			String tableName = (String)JOptionPane.showInputDialog(this.frame, "Nom de la Table o&ugrave; supprimer la ligne :", "Choix de la table",JOptionPane.PLAIN_MESSAGE,null,listOfTable,listOfTable[0]);	
