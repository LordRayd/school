	...
	public class TestPays{
		...
		public static void main(String[] args){
			...
			tabPays[1] = new Pays("Chile",16454143,756950);
 			...
 			liste.add(new Pays("Cuba",11423952,110860));
 			liste.add(new Pays("Chile",16454143,756950));
 			liste.add(new Pays("Russia",140702094,17075200));
 			liste.add(new Pays("Norway",4644457,323802));

 			Population popu = new Population(liste,liste);
 			popu.toString();
 		}
	}