	...
	public class TestPartA {
		...
		/**
	 	 * Test the Eleves object
	 	 * @param args the possible argument
	 	 */
		public static void main(String[] args){
			Eleves eleve1 = new Eleves("Robert");
			Eleves eleve2 = new Eleves("Bernarde");
			...
			eleve1.ecrireTexte("eleve1");
			eleve2.ecrireTexte("eleve2");
			eleve1.lireTexte("eleve2");
			eleve2.lireTexte("eleve1");
