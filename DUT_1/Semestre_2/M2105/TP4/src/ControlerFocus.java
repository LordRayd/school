...
public class ControlerFocus implements FocusListener {
	...
	public void focusLost(FocusEvent e){
		...
		if(e.getSource() == iP.getCourrielJTF()){
			// JTextField vide
			if(iP.getCourrielJTF().getText().isEmpty()){
				iP.getCourriel().setText("<html>Courriel<br/><FONT COLOR=RED>Nothing</FONT></html>");
			} else {
				iP.getCourriel().setText("Courriel");
			}
		}
	}
}
